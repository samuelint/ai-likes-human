...
export default function MessageCollection({ messages = [], byIdRuns = {}, isLoading, children }: Props) {

  return (
    <div className="select-text flex flex-col h-full overflow-y-auto py-4 px-2 md:px-20 lg:px-32">
